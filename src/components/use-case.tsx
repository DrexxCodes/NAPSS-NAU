    ...
    <section className="use-cases-section">
      <div className="use-cases-container">
        <div className="use-cases-header">
          ...
          <p className="use-cases-subtitle">Discover the versatile applications of our NFC-powered smart cards</p>
        </div>
        ...
        <div className="use-cases-grid">
          {useCases.map((useCase, index) => (
            <div
              key={index}
              className={`use-case-card ${hoveredIndex !== null && hoveredIndex !== index ? "grayscale" : ""}`}
              onMouseEnter={() => setHoveredIndex(index)}
              onMouseLeave={() => setHoveredIndex(null)}
            >
              <div className="use-case-image-container">
                <img src={useCase.image || "/placeholder.svg"} alt={useCase.title} className="use-case-image" />
